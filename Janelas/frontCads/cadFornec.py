...
class Fornecedores(CadForn):
    def cadforn(self):
        ...
        self.win_for.configure(background="gray40")
        ...
        self.entr_for.place(relx=0.11, rely=0.13, relwidth=0.25, relheight=0.07)
        ...
        bt_ld_f.place(relx=0.17, rely=0.01, relwidth=0.1, relheight=0.12)

        bt_cl_f = ButtonGlac(self.win_for, self.m_Limpar, self.limpa_fornecedor)
        bt_cl_f.place(relx=0.27, rely=0.01, relwidth=0.1, relheight=0.12)

        bt_busc_for = ButtonGlac(self.win_for, self.m_Buscar, self.busca_fornecedor)
        bt_busc_for.place(relx=0.37, rely=0.11, relwidth=0.1, relheight=0.11)
        ...
        bt_nv_for.place(relx=0.1, rely=0.8, relwidth=0.09, relheight=0.12)

        bt_alt_for = ButtonGlac(self.win_for, self.m_Alterar, self.mud_fornec)
        bt_alt_for.place(relx=0.2, rely=0.8, relwidth=0.09, relheight=0.12)

        bt_del_for = ButtonGlac(self.win_for, self.m_Apagar, self.del_fornec)
        bt_del_for.place(relx=0.3, rely=0.8, relwidth=0.09, relheight=0.12)
