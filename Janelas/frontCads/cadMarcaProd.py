...
class MarcaProdutos(CadMarcaProd):
    def cadmarcaprod(self):
        ...
        self.janelaM.configure(background="gray50")
        ...
        botaoAdd.place(x=145, y=20, width=130, height=25)

        ###  Botao limpa automovel
        botaolimpa = ButtonGlac(self.janelaM, self.m_Limpar, self.limpa_marca_prod)
        botaolimpa.place(x=280, y=20, width=70, height=25)
        ...
        botaobusca.place(x=285, y=50, width=70, height=25)
        ...
        botaoAdd.place(x=30, y=150, width=85, height=25)

        # botao mudar
        botaoMud = ButtonGlac(self.janelaM, self.m_Alterar, self.mud_marca_prod)
        botaoMud.place(x=130, y=150, width=85, height=25)

        # botao deletar
        botaoDel = ButtonGlac(self.janelaM, " Apagar ", self.del_marca_prod)
        botaoDel.place(x=230, y=150, width=85, height=25)
