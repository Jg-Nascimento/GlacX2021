...
class PrimeiroFrame:
    ...
    def primeiro_frame(self):
        ...
        self.ClientBot = ButtonGlac(self.top, '', self.customer_registration,
                                    'Cadastro de clientes', bg_bt)
        ...
        self.FornecBot = ButtonGlac(self.top, '', self.cadforn, 'Cadastro de Fornecedores', bg_bt)
        ...
        self.ModelosBot = ButtonGlac(self.top, '', self.cadaut, 'Cadastro de automoveis', bg_bt)
        ...
        self.ProdutosBot = ButtonGlac(self.top, '', self.cadprod, 'Cadastro de produtos', bg_bt)
        ...
        self.ServBot = ButtonGlac(self.top, '', self.cadserv, 'Cadastro de serviços', bg_bt)
