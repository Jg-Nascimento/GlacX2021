...
class BuscaCliente:
    ...
    def busca_cliente(self):
        ...
        ButtonClienteNovo.place(relx=0.74, y=345, height=35)

        LabelCliente2 = LabelGlac(self.listacliente, self.m_BuscaCliMsg3)
        LabelCliente2.place(relx=0.02, rely=0.88, relwidth=0.72, relheight=0.05)
        LabelCliente2 = LabelGlac(self.listacliente, self.m_BuscaCliMsg4)
        LabelCliente2.place(relx=0.02, rely=0.93, relwidth=0.72, relheight=0.05)
